                ...
                args=[
                    {
                        "ins": ['input'],
                        "dtype": [Skip(np.float64),],
                        "shape": [Skip((2, 512, 38, 38)),Skip((0,)),Skip((0, 8)),
                                  Skip((7, 0, 9)),],
                    },
                ]
            ),
                ...
                args=[
                    {
                        ...
                        "dtype": [Skip(np.float64),Skip(np.int8),Skip(np.int16),
                                  Skip(np.int32),Skip(np.int64),Skip(np.uint8),],
                        "shape": [Skip((0,)),Skip((0, 4)),Skip((9, 0, 3)),],
                    },
                    {
                        "ins": ['exponent'],
                        "dtype": [Skip(np.float64),Skip(np.int8),Skip(np.int16),
                ...
                args=[
                    {
                        ...
                        "dtype": [Skip(np.float64),Skip(np.int16),Skip(np.int32),
                                  Skip(np.int64),Skip(np.int8),Skip(np.uint8),
                                  Skip(np.bool_),],
                        "shape": [Skip((8,)),Skip((70, 1, 2)),
                                  Skip((0,)),Skip((0, 4)),Skip((9, 0, 6)),],
                    },
                ]
            ),
        ),
                ...
                args=[
                    {
                        "ins": ['input'],
                        "dtype": [Skip(np.float64),],
                        "shape": [Skip(()),Skip((2, 64, 3, 3, 3)),Skip((0,)),
                                  Skip((0, 2)),Skip((16, 0, 9)),],
                    },
                ]
            ),
        ),
